{
  ...
  inputs = {
    ...
    # mcp-v8: consume the mcp-js flake's own package (it already handles the
    # rusty_v8 prefetch and cargo vendor hash).
    mcp-js.url = "github:r33drichards/mcp-js/claude/kodex-mcp-js-library-37218h";
